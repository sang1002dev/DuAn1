...
import sanghvph30000.fpoly.duan1.Fragment.ChiTietSPFrgm;
import sanghvph30000.fpoly.duan1.Fragment.ChiTietSPSuaFrgm;
...
//        Set Data cho List Item
        ...
        //
        String outTongTien = String.format("%,.0f", sanPham.getDonGia());
...
//        Button thêm sản phẩm vào giỏ hàng (Icon ADD)
        holder.add_sanpham.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                Khởi tạo Model
                GioHang gioHang = new GioHang(1, sanPham.getId(), 1, sanPham.getDonGia());
